...
public class ShaderPanel extends JPanel implements Runnable {
	...
	private final long FPS_TARGET = 30;
	...
	ShaderPanel(int w, int h) {
		...
		// Tell Java that the image source will be continuously updated in
		// memory
	...
	public void run() {
		...
		while (true) { // Loop forever (until program exits)
			...
			try {
				// Thread.sleep(40); // Delay and leave some power for other
				// programs
				// NO NO NO. Marcus needs moar FPS's
